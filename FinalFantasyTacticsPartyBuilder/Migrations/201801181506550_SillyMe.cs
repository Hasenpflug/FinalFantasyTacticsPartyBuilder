namespace FinalFantasyTacticsPartyBuilder.Migrations
{
    ...
    public partial class SillyMe : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        PhysicalAttackModifier = c.Boolean(nullable: false),
                        PhysicalDefenceModifier = c.Boolean(nullable: false),
                        HpPercentBoost = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        PspName = c.String(),
                        PsxName = c.String(),
                        AbilitySetPsxName = c.String(),
                        AbilitySetPspName = c.String(),
                        IsMaleOnly = c.Boolean(nullable: false),
                        IsFemaleOnly = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        CanDualWield = c.Boolean(nullable: false),
                        CanDoubleHand = c.Boolean(nullable: false),
                        IsTwoHandOnly = c.Boolean(nullable: false),
                        StartingItemImagePath = c.String(),
                    })
                ...
                c => new
                    {
                        ...
                        IsStartingItem = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        UnitNameID = c.Int(nullable: false, identity: true),
                        Name = c.String(),
                        Gender = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.UnitNameID);
